...
public class output {
        ...
        public static void printpacket(Integer count11){
		  ...
		  System.out.println("--------------------------------------------------------------------------------------------");
                  ...
                  if(printing_packet.src_port1 != 99999){
                        ...
                        System.out.println("Source IP : "+(String) printing_packet.src_ip1);
                        System.out.println("Destination IP : "+(String) printing_packet.dest_ip1);
                  }
	...
	public static void printpacketdestip(Integer count11){
		  ...
		  System.out.println("--------------------------------------------------------------------------------------------");
                  PacketData printing_packet = Data.alldata_map.get(count11);
		  System.out.println("Packet Number : "+count11);
		  if(printing_packet.dest_port1 != 99999)
                        System.out.println("Source IP : "+(String) printing_packet.dest_ip1);
                  else
                        System.out.println("Source IP : "+(String) printing_packet.dest_ip1);
